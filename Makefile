...
FIRMWARE_OBJS = firmware/start.o firmware/irq.o firmware/print.o firmware/final_pcpi.o firmware/knn_mmap.o firmware/stats.o
DBFILE      = *.fsdb *.vcd *.bak
...
pcpi: firmware/firmware.hex
	ncverilog testbench_pcpi.v final_pcpi.v picorv32.v +define+COMPRESSED_ISA +access+r
...
pcpi_fsdb: firmware/firmware.hex
	ncverilog testbench_pcpi.v final_pcpi.v picorv32.v +define+COMPRESSED_ISA +fsdb +trace +noerror +access+r
